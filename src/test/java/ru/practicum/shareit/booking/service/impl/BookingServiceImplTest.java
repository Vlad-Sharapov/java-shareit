...
class BookingServiceImplTest extends EntitiesForBookingTests {
    ...
    @Test
    void shouldThrowBadRequestExceptionWhenAddBookingWithInvalidDateInterval() {

        assertThrows(BadRequestException.class,
                () -> bookingService.add(user1.getId(), BookingDto.builder()
                        .itemId(booking1.getItem().getId())
                        .start(booking1.getEnd())
                        .end(booking1.getStart())
                        .build()));
    }
    ...
    @Test
    void getAllUserBookingsWithUnsupportedStatus() {

        assertThrows(BadRequestException.class,
                () -> bookingService.getAllUserBookings(user1.getId(), "QWERTY", 0, 5));
    }
    ...
    @Test
    void getAllOwnerBookingsWithUnsupportedStatus() {

        assertThrows(BadRequestException.class,
                () -> bookingService.getAllOwnerBookings(user1.getId(), "QWERTY", 0, 5));
    }
}